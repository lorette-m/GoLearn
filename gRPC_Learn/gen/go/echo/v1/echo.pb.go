...
const file_api_echo_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/echo.proto\x12\aecho.v1\"'\n" +
	"\vEchoRequest\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"(\n" +
	"\fEchoResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2B\n" +
	"\vEchoService\x123\n" +
	"\x04Echo\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponseB7Z5github.com/lorette-m/gRPC_Learn/gen/go/echo/v1;echov1b\x06proto3"

var (
	file_api_echo_proto_rawDescOnce sync.Once
	file_api_echo_proto_rawDescData []byte
)

func file_api_echo_proto_rawDescGZIP() []byte {
	file_api_echo_proto_rawDescOnce.Do(func() {
		file_api_echo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_echo_proto_rawDesc), len(file_api_echo_proto_rawDesc)))
	})
	return file_api_echo_proto_rawDescData
}

var file_api_echo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_echo_proto_goTypes = []any{
...
func file_api_echo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_echo_proto_rawDesc), len(file_api_echo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
